...
; OpenSSL
Source: "{#HMAILSERVERLIBS}\openssl-1.0.2q\out64\libeay32.dll"; DestDir: "{app}\Bin"; Flags: ignoreversion; Components: server admintools;
Source: "{#HMAILSERVERLIBS}\openssl-1.0.2q\out64\ssleay32.dll"; DestDir: "{app}\Bin"; Flags: ignoreversion; Components: server admintools;
